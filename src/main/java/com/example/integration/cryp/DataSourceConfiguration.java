package com.example.integration.cryp;
...
public class DataSourceConfiguration {
 ...
 /*   public DataSource dataSource() throws Exception{
	...
	public static void main(String[] args) throws Exception {
		String name = Des3.encryptThreeDESECB("getName223", Des3.DES3KEY);
		String wordString = Des3.decryptThreeDESECB(name, Des3.DES3KEY);
		System.out.println(name+","+ wordString);
	}
}
