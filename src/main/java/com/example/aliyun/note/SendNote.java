package com.example.aliyun.note;
...
public class SendNote {
    ...
    private String addSmsTemplate() throws ClientException {
        ...
        addSmsTemplateRequest.setSysVersion("2017-05-25");//api版本号不能改
        ...
        // 模板内容，长度为1~500个字符
        //addSmsTemplateRequest.putQueryParameter("TemplateContent", "菜鸡, 您的手机回收，5分钟内有效！");
    ...
    private String sendSms(String templateCode) throws ClientException {
        ...
        // 接收短信的手机号码
        request.putQueryParameter("PhoneNumbers", "18762988789");
    ...
    private void querySendDetails(String bizId) throws ClientException {
        ...
        // 接收短信的手机号码
        request.putQueryParameter("PhoneNumber", "18762988789");
    ...
    public static void main(String[] args) {
    	SendNote sendSmsDemo = new SendNote();
